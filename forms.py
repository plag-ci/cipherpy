...
class CipherForm(Form):
	...
	algorithm = SelectField('form-control', choices=[(0,'Ceasar'),(1,'Affine'),(6,'Additive'),(7,'Multiplicative'),(5,'Substitution'),(2,'Playfair'),(3,'Vigenere'),(4,'Autokey')])
	switch = SelectField('form-control', choices=[(0,'decipher'),(1,'encipher')])
